...
def get_image_url(api_option):
    try:
        if api_option["name"] == "cat":
            ...
            params = {"key": PIXABAY_API_KEY, "q": "cat", "image_type": "photo", "per_page": 3, "page": page}
            ...
            params = {"method": "flickr.photos.search", "api_key": FLICKR_API_KEY, "tags": "cat", "per_page": 1, "page": page, "format": "json", "nojsoncallback": 1}
            response = requests.get(api_option["url"], params=params)
            if response.status_code == 200:
